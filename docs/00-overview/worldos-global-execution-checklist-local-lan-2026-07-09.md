...
- [x] Gateway 到 Atlas：表达视角拉远/展开地图。
- [x] Atlas 到 Node：表达星点进入节点房间。
- [x] Timeline 到 Node：表达时间片展开。
- [x] Archive 到 Node：表达档案抽出。
- [x] Paths 到 Node：表达旅程抵达。
- [x] reduced-motion 下统一转为静态状态提示。
- [x] 避免转场遮挡 H1、主 CTA、移动导航和正文。
