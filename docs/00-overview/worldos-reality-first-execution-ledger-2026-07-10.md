...
| RF-003 | P0 | 核心场景共享同一个双栏 portal 模板 | `src/components/world/SceneWorldPortal.tsx` | open-5-core-imports |
...
| C2 | 世界壳与 Gateway | passed | 本检查点提交 | c2-gateway-2026-07-10 |
| C3 | Atlas 可探索地图 | in_progress | - | - |
...
| C2 | 本检查点提交 | `feat(world): 重塑世界入口与回访抵达体验` | 提交后复核 |
