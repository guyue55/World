...
| C1 | 视觉资产、token 与 scene primitives | passed | 本检查点提交 | assets-2026-07-10 |
| C2 | 世界壳与 Gateway | in_progress | - | - |
...
| C1 | 本检查点提交 | `feat(world): 建立七类场景视觉资产与基础控件` | 提交后复核 |
