...
> [!IMPORTANT]
> M19-M30 必须同时服从 `docs/00-overview/worldos-ultimate-experience-charter-2026-07-10.md`。任何阶段如果没有推进至少一个终局体验支柱，不能算有效推进。
...
| 权限可靠 | 后端 / 数据契约边界扫描 |
| 独立空间 | 遮掉文案后的场景辨识测试 |
| 真实穿梭 | 关键路径录屏和 reduced-motion 替代 |
| 内容生命体 | 单节点多场景吸收证明 |
| 陪伴型灯塔 | grounded 问路、推荐、失败回退 |
| 统一世界观 | 音乐 / 氛围 / 视觉 / 交互一致性审查 |
| 长期回访 | 再访、继续路径、历史清除演练 |
