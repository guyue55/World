...
const liveNodes = [
  { id: '入口', href: '/', left: '13%', top: '45%', delay: 0 },
  { id: '地图', href: '/atlas', left: '34%', top: '22%', delay: 0.35 },
  { id: '时间', href: '/timeline', left: '62%', top: '30%', delay: 0.75 },
  { id: '路径', href: '/paths/eight-minute-world', left: '46%', top: '66%', delay: 1.05 },
  { id: '灯塔', href: '/ask', left: '78%', top: '55%', delay: 1.4 },
]
...
export function WorldLiveMapPanel() {
      ...
      {liveNodes.map((node) => (
        ...
        >
          <motion.span
            ...
            transition={{ duration: 5.2, delay: node.delay, repeat: Infinity, ease: 'easeInOut' }}
          >
            {node.id}
          </motion.span>
        </Link>
