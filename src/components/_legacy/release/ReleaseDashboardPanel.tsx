import { getPhaseSevenReleaseDashboard } from '@/lib/phase-seven-release'

export function ReleaseDashboardPanel() {
  const dashboard = getPhaseSevenReleaseDashboard()

  return (
    <section className="rounded-world border border-ink/10 bg-white/45 p-6 shadow-soft">
      <h2 className="text-2xl font-semibold">发布看板</h2>
