  ...
  return (
    <ResponsivePageShell>
      <section className="rounded-world border border-ink/10 bg-white/50 p-8 shadow-soft">
        ...
        <h1 className="mt-4 text-4xl font-semibold md:text-6xl">联邦化智能世界网络</h1>
        <p className="mt-5 max-w-3xl leading-8 text-ink/70">V5 聚合联邦世界、多 Agent 编排、插件市场、观测治理与世界迁移。</p>
