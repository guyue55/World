import batch from '../data/v4/stage-05/18-multi-channel-publishing.json'

const errors: string[] = []

if (batch.batch !== 18) errors.push('batch number mismatch')
...
console.log('V4 batch 18 check passed.')
