import batch from '../data/v6/stage-05/20-memory-universe-final.json'

const errors: string[] = []

if (batch.batch !== 20) errors.push('batch number mismatch')
...
console.log('V6 batch 20 check passed.')
