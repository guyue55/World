import batch from '../data/v5/stage-03/10-agent-orchestration-protocol.json'

const errors: string[] = []

if (batch.batch !== 10) errors.push('batch number mismatch')
...
console.log('V5 batch 10 check passed.')
