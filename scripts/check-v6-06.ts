import batch from '../data/v6/stage-02/06-world-routing-discovery.json'

const errors: string[] = []

if (batch.batch !== 6) errors.push('batch number mismatch')
...
console.log('V6 batch 06 check passed.')
