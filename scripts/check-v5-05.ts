import batch from '../data/v5/stage-02/05-federated-world-model.json'

const errors: string[] = []

if (batch.batch !== 5) errors.push('batch number mismatch')
...
console.log('V5 batch 05 check passed.')
