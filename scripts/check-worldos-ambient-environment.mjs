...
assert(sensoryAudioRegistry.name === 'WorldOS M13 感官与声景注册表', 'Sensory Audio Registry 名称不正确')
...
for (const token of ['getSensoryAudioSummary', 'sensoryAudioSummary', 'Sensory Audio M13']) {
