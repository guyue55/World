import batch from '../data/v6/stage-03/11-knowledge-creation-pipeline.json'

const errors: string[] = []

if (batch.batch !== 11) errors.push('batch number mismatch')
...
console.log('V6 batch 11 check passed.')
